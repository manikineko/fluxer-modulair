...
read -p "Server port [49319]: " SERVER_PORT
SERVER_PORT=${SERVER_PORT:-49319}

read -p "Gateway port [49107]: " GATEWAY_PORT
GATEWAY_PORT=${GATEWAY_PORT:-49107}

read -p "Marketing port [49531]: " MARKETING_PORT
MARKETING_PORT=${MARKETING_PORT:-49531}

read -p "Static CDN port [8082]: " STATIC_CDN_PORT
