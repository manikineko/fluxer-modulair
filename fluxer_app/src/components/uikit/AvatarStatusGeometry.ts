...
const STATUS_GEOMETRY: Record<number, StatusGeometry> = {
	...
	44: {size: 14, cx: 38, cy: 38, radius: 10, borderWidth: 3, isMobile: false},
...
const STATUS_GEOMETRY_MOBILE: Record<number, StatusGeometry> = {
	...
	44: {size: 14, cx: 38, cy: 38, radius: 10, borderWidth: 3, isMobile: true, phoneWidth: 14, phoneHeight: 21},
