...
export const ChannelTypeSchema = withOpenApiType(
	createInt32EnumType(
		[
			...
			[ChannelTypes.BLUESKY_FEED, 'BLUESKY_FEED', 'AT Protocol feed for Bluesky timeline'],
			[ChannelTypes.SSR_RENDER, 'SSR_RENDER', 'Sandboxed server-side rendering for custom content'],
			[ChannelTypes.GUILD_ANNOUNCEMENT, 'GUILD_ANNOUNCEMENT', 'Announcement channel for important messages'],
			[ChannelTypes.GUILD_FORUM, 'GUILD_FORUM', 'Forum channel for organized discussions'],
			[ChannelTypes.GUILD_STAGE, 'GUILD_STAGE', 'Stage channel for events and presentations'],
		],
